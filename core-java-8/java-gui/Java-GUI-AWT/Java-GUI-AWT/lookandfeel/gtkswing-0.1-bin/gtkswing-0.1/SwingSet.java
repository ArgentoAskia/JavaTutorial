...
public class SwingSet extends JPanel
{
    ...
    // L&F radio buttons
    JRadioButtonMenuItem gtkMenuItem;
  ...
  void loadImages() {
	...
	ToggleUIListener toggleUIListener = new ToggleUIListener();
        ...
        gtkMenuItem = (JRadioButtonMenuItem) options.add(new JRadioButtonMenuItem("Gtk Look and Feel"));
	gtkMenuItem.setSelected(UIManager.getLookAndFeel().getName().equals("Gtk"));
	gtkMenuItem.setSelected(true);
	gtkMenuItem.setEnabled(isAvailableLookAndFeel(gtkClassName));
	group.add(gtkMenuItem);
	gtkMenuItem.addItemListener(toggleUIListener);
	gtkMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_1, ActionEvent.ALT_MASK));
	    ...
	    JRadioButtonMenuItem rb = (JRadioButtonMenuItem) e.getSource();
		   ...
		   currentUI = "Motif";
	    	   UIManager.setLookAndFeel("com.sun.java.swing.plaf.motif.MotifLookAndFeel");
                   tabPlacement.setEnabled(true);
	    	   SwingUtilities.updateComponentTreeUI(getRootComponent());
	       } else if(rb.isSelected() && rb.getText().equals("Gtk Look and Feel")) {
		   currentUI = "Gtk";
	    	   UIManager.setLookAndFeel("org.gtk.java.swing.plaf.gtk.GtkLookAndFeel");
                   tabPlacement.setEnabled(true);
	    	   SwingUtilities.updateComponentTreeUI(getRootComponent());
