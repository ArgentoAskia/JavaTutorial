...
public class FlowLayoutDemo {
    ...
    public static void main(String[] args) {
        ...
        Panel componentOrientationPanel = new Panel();

        // 创建组件
        Label hGapLabel = new Label("水平间距(hGap)");
        Label vGapLabel = new Label("垂直间距(vGap)");
        Label alignLabel = new Label("对齐方式(align)");
        Label panelComponentOrientationLabel = new Label("Panel容器方向(ComponentOrientation):");
        ...
        Choice componentOrientationChoice = new Choice();
        componentOrientationChoice.add("LEFT_TO_RIGHT");
        componentOrientationChoice.add("RIGHT_TO_LEFT");
        componentOrientationChoice.add("UNKNOWN");
        ...
        componentOrientationPanel.add(panelComponentOrientationLabel);
        componentOrientationPanel.add(componentOrientationChoice);
        ...
        controlPanel.add(componentOrientationPanel);
...
//                buttonPanel.validate();
                // 设置Panel
                final String selectedItem = componentOrientationChoice.getSelectedItem();
                if (selectedItem.equalsIgnoreCase("left_to_right")){
                    buttonPanel.setComponentOrientation(ComponentOrientation.LEFT_TO_RIGHT);
                    buttonPanel.applyComponentOrientation(ComponentOrientation.LEFT_TO_RIGHT);
                }
                else if(selectedItem.equalsIgnoreCase("right_to_left")){
                    buttonPanel.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
                    buttonPanel.applyComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
                }
                else{
                    buttonPanel.setComponentOrientation(ComponentOrientation.UNKNOWN);
                    buttonPanel.applyComponentOrientation(ComponentOrientation.UNKNOWN);
                }
