package cn.argento.askia.io.stream.bytes;
...
public class ByteArrayOutputStreamDemo {
    public static void main(String[] args) throws Exception{
        ...
        URL location = BufferedOutputStreamDemo.class.getProtectionDomain().getCodeSource().getLocation();
        File file = new File(location.getPath() + "/ByteArrayStream/ByteArrayOutputText.txt");
