 ...
 */
package cn.argento.askia.com.fifesoft.autocomplete;
...
class CCellRenderer extends CompletionCellRenderer {
	 ...
	 */
	CCellRenderer() {
		variableIcon = getIcon("java-three-party/src/main/resources/img/var.png");
		functionIcon = getIcon("java-three-party/src/main/resources/img/function.png");
	}
